...
public class RentalDto {
    ...
    public static class RentalResponse {
        ...
        public RentalResponse(String userName, String orgName, String itemName, LocalDateTime rentalStartDate, LocalDateTime rentalEndDate, LocalDateTime returnDate) {
